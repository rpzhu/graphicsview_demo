...
//定时器事件
void
GraphWidget::timerEvent(QTimerEvent* event)
{
    Q_UNUSED(event);
...
void
GraphWidget::wheelEvent(QWheelEvent* event)
{
...
void
GraphWidget::drawBackground(QPainter* painter, const QRectF& rect)
{
    Q_UNUSED(rect);
...
//缩放视图
void
GraphWidget::scaleView(qreal scaleFactor)
{
