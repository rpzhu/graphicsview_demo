...
#include <memory>
#include "../../embeddeddialogs/embeddeddialog.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_EmbeddedDialog_t, stringdata0) + ofs \
...
void EmbeddedDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<EmbeddedDialog *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject EmbeddedDialog::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_meta_stringdata_EmbeddedDialog.data,
    qt_meta_data_EmbeddedDialog,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *EmbeddedDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_EmbeddedDialog.stringdata0))
