...
#include <memory>
#include "../../padnavigator/roundrectitem.h"
...
void RoundRectItem::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::ReadProperty) {
        auto *_t = static_cast<RoundRectItem *>(_o);
        Q_UNUSED(_t)
        void *_v = _a[0];
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject RoundRectItem::staticMetaObject = { {
    QMetaObject::SuperData::link<QGraphicsObject::staticMetaObject>(),
    qt_meta_stringdata_RoundRectItem.data,
    qt_meta_data_RoundRectItem,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *RoundRectItem::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_RoundRectItem.stringdata0))
